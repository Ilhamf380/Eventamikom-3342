...
<body class="bg-slate-50 text-slate-900">
    ...
    <a href="{{ route('home') }}"
       class="{{ request()->is('/') ? 'text-indigo-600' : 'hover:text-indigo-600' }}">
       Jelajahi
    </a>

    <a href="{{ route('katalog') }}"
       class="{{ request()->is('katalog') ? 'text-indigo-600' : 'hover:text-indigo-600' }}">
       Kategori
    </a>

    <a href="{{ route('contact') }}"
       class="{{ request()->is('contact') ? 'text-indigo-600' : 'hover:text-indigo-600' }}">
       Tentang Kami
    </a>
